...
const Headers = (props: Props) => {
  ...
  return (
    <Header className=" header bg-[#FFFFFF] h-16 shadow-sm grid lg:grid-cols-6 md:grid-cols-2 sm:grid-cols-2 ">
      <div className="header__list lg:col-start-6 flex  justify-evenly md:col-start-2 sm:col-start-2  items-center sm:text-sm lg:text-lg md:text-base relative ">
          ...
          <Avatar
            src={
              Authstore.user.avatarURL
                ? getImgName(Authstore.user.avatarURL)
                : undefined
            }
          >
            {Authstore.user.name}
        ...
        {openSetting ? (
          <div className="absolute top-14 lg:-left-[0%] md:-left-[20%] sm:-left-[100%] min-w-[250px] bg-[#FFFFFF] h-[250px] rounded-lg border border-slate-300 z-10">
            <ul className="divide-y">
              ...
              <li className="flex flex-col justify-start items-start h-24">
                <button className="h-11 hover:bg-[#F7F8F8] w-full ">
                  <Link to="/employee/setting"> Setting</Link>
                </button>
                <button className="h-11 hover:bg-[#F7F8F8] w-full mt-1">
              ...
              >
                <button className="hover:bg-[#F7F8F8] w-full m-auto h-full">
                  Sign out
                </button>
              </li>
            </ul>
        ...
        {openSearch ? (
          <div className="w-screen h-screen bg-[rgba(31,31,34,0.3)] fixed top-0 right-0 z-40">
            <div className="fixed top-[50%] left-[50%] min-w-[300px] lg:min-w-[600px] lg:min-h-[250px] bg-[#FFFFFF] min-h-[400px] translate-x-[-50%] translate-y-[-50%] rounded-lg">
              <div className="flex justify-between align-baseline bg-[#5048E5] rounded-t-lg h-16 items-center text-[#FFFFFF] ">
                ...
                <div>
                  <MdClear
                    className="font-bold mr-6 w-full  cursor-pointer"
              ...
              <div className="flex justify-start items-center text-sm bg-[#F3F4F6] rounded-lg h-9 mt-4 ml-6 mr-6">
                <span className="ml-4">
                  <MdOutlineTipsAndUpdates className="fill-[#65748B] text-lg" />
                </span>
                <span className="text-[#65748B] font-semibold ml-2">Tip.</span>
                <p className="block ml-4 text-[#65748B]">
              ...
              <div className="mt-6">
                <form className="relative ml-6 mr-6">
                  ...
                  <input
                    type="text"
                    placeholder="Search "
                    className="placeholder:italic placeholder:text-slate-400 w-full h-14 border-[#E6E8F0] border-[1px] focus:border-[2px] focus:border-[#5048E5] outline-none rounded-lg pl-10 sm:text-sm peer"
                  />

                  <span className="absolute -top-2 left-5 text-sm bg-[#FFFFFF] text-[#B0B8C4] peer-focus:text-[#5048E5]">
                    Search
                  </span>
                </form>
              </div>
